...
tmux new-session -d -t impala_sonic

tmux new-window -d -n learner
COMMAND_LEARNER='python3.7 learner.py --env_num '"${NUM_ACTORS}"' --gpu_use --pretrained_model '"${PRE_TRAINED_MODEL}"''
